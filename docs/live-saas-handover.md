...
- SaaS portal: https://brijvas.com/saas/
- New customer signup: https://brijvas.com/saas/signup/
- Business login: https://brijvas.com/saas/login/
- Business selection after login: https://brijvas.com/saas/workspaces/
- Existing Brijvas management: https://brijvas.com/saas/business/brijvas/
- Platform administration: https://brijvas.com/admin/ (superuser only)
...
3. Share `https://brijvas.com/sites/<customer-slug>/`; it is usable immediately without new DNS or certificate provisioning.
