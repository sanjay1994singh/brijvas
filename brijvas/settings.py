...
WHATSAPP_PROVIDER = os.getenv('WHATSAPP_PROVIDER', 'fast2sms')
WHATSAPP_NOTIFICATIONS_ENABLED = os.getenv('WHATSAPP_NOTIFICATIONS_ENABLED', 'False').lower() in ('1', 'true', 'yes', 'on')
WHATSAPP_FAST2SMS_API_KEY = os.getenv('WHATSAPP_FAST2SMS_API_KEY', os.getenv('WHATSAPP_CLOUD_API_TOKEN', ''))
WHATSAPP_PHONE_NUMBER_ID = os.getenv('WHATSAPP_PHONE_NUMBER_ID', '')
WHATSAPP_FAST2SMS_VERSION = os.getenv('WHATSAPP_FAST2SMS_VERSION', 'v26.0')
WHATSAPP_CLOUD_API_TOKEN = os.getenv('WHATSAPP_CLOUD_API_TOKEN', '')
WHATSAPP_TEMPLATE_LANGUAGE = os.getenv('WHATSAPP_TEMPLATE_LANGUAGE', 'hi')
WHATSAPP_PAYMENT_SUCCESS_TEMPLATE = os.getenv('WHATSAPP_PAYMENT_SUCCESS_TEMPLATE', 'plan_purchased_success')
WHATSAPP_PAYMENT_SUCCESS_MESSAGE_ID = os.getenv('WHATSAPP_PAYMENT_SUCCESS_MESSAGE_ID', '32923')
